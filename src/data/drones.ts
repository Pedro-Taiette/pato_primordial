...
export const DRONES: DroneModel[] = [
  ...
  },
  {
    ...
    serialFixed: "PTX-FALCON-001",
    image: new URL("../assets/drones/patox-falcon.png", import.meta.url).href,
    turboStats: { potencia: 7, estoque: 6, producao: 8 },
  },
  {
    id: "quacksa-saturn",
    brand: "Quacksa",
    ...
    serialFixed: "QKS-SATURN-001",
    image: new URL("../assets/drones/quacksa-saturn.png", import.meta.url).href,
    turboStats: { potencia: 9, estoque: 4, producao: 6 },
  },
  {
    id: "dsin-apollo",
    brand: "DSIN",
    ...
    serialFormat: {
      prefix: "DSIN",
      pattern: "AA##-AP",
      example: "DSIN-AB12-AP",
    },
    serialFixed: "DSIN-APOLLO-001",
    image: new URL("../assets/drones/dsin-apollo.png", import.meta.url).href,
    turboStats: { potencia: 8, estoque: 7, producao: 7 },
  },
  {
    id: "patox-dragon",
    brand: "PatoX",
    ...
    serialFixed: "PTX-DRAGON-001",
    image: new URL("../assets/drones/patox-dragon.png", import.meta.url).href,
    turboStats: { potencia: 9, estoque: 5, producao: 6 },
  },
  {
    id: "quacksa-ares",
    brand: "Quacksa",
    ...
    serialFixed: "QKS-ARES-001",
    image: new URL("../assets/drones/quacksa-ares.png", import.meta.url).href,
    turboStats: { potencia: 7, estoque: 7, producao: 8 },
  },
  {
    id: "dsin-vostok",
    brand: "DSIN",
    ...
    reads: [
      ...
      { key: "danoTiro", label: "Dano de Tiro", value: 8 },
      { key: "taxaTiro", label: "Taxa de Tiro", value: 5 },
      { key: "cortaVento", label: "Corta Vento", value: 8 },
      { key: "resistencia", label: "Resistência", value: 7 },
      { key: "precisao", label: "Precisão", value: 6 },
    ],
    duckUnits: { altura: "cm", peso: "g" },
    serialFormat: {
      prefix: "DSIN",
      pattern: "##-VSTK",
      example: "DSIN-99-VSTK",
    },
    serialFixed: "DSIN-VOSTOK-001",
    image: new URL("../assets/drones/dsin-vostok.png", import.meta.url).href,
    turboStats: { potencia: 8, estoque: 6, producao: 7 },
  },
];
